...
Screen.prototype={
    ...
    createBalls:function () {
        ...
        for (i=0;i<num;i++) {
            ...
            //ball.vx=Math.random() * 16 - 3;//设定初始速度
            //ball.vy=Math.random() * 16 - 3;
            ball.vx = 0;
            ball.vy = 0;
        ...
        self.balls[2].style.left=30+'px';
        self.balls[2].style.top=429+'px';
        ...
        self.balls[7].style.left=732+'px';
        self.balls[7].style.top=237+'px';
        self.balls[8].style.left=757+'px';
        self.balls[8].style.top=251+'px';
        self.balls[9].style.left=757+'px';
        self.balls[9].style.top=223+'px';
        self.balls[10].style.left=781+'px';
        self.balls[10].style.top=265+'px';
        self.balls[11].style.left=781+'px';
        self.balls[11].style.top=237+'px';
        self.balls[12].style.left=781+'px';
        self.balls[12].style.top=209+'px';
        self.balls[13].style.left=805+'px';
        self.balls[13].style.top=279+'px';
        self.balls[14].style.left=805+'px';
        self.balls[14].style.top=251+'px';
        self.balls[15].style.left=805+'px';
        self.balls[15].style.top=223+'px';
        self.balls[16].style.left=805+'px';
        self.balls[16].style.top=195+'px';
        self.balls[17].style.left=828+'px';
        self.balls[17].style.top=293+'px';
        self.balls[18].style.left=828+'px';
        self.balls[18].style.top=265+'px';
        self.balls[19].style.left=828+'px';
        self.balls[19].style.top=237+'px';
        self.balls[20].style.left=828+'px';
        self.balls[20].style.top=209+'px';
        self.balls[21].style.left=828+'px';
        self.balls[21].style.top=181+'px';
        self.balls[2].vx=Math.random() * 116 - 3;//设定初始速度
        self.balls[2].vy=Math.random() * 116 - 3;
...
window.onload=function() {
    ...
    document.getElementById("inner").innerHTML='';
        sc=new Screen('inner',{ballsnum: 22, spring: 0.8, bounce: -0.9, gravity: 0});
        sc.initialize();
